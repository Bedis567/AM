...
<View style={{ width:'100%', flex:0.75}}>
    ...
    <View style={{backgroundColor:colors.lightGrey,width:350, height:75, justifyContent:'center', alignItems:'stretch', justifyContent:'center',borderColor:'black', borderWidth:1, borderRadius:30, margin:10 }}>
        <TextInput placeholder='Description' style={{fontFamily:'Montserrat-Bold', fontSize:25, margin:20 }}/>
    </View>
      <View style={{width:'90%', height:'30%', alignItems:'center', justifyContent:'center' }}>
      <TouchableOpacity style={{  backgroundColor:colors.lightGrey , margin:5, borderColor:'black', width:350, height:75,borderRadius:50, borderWidth:1, justifyContent:"center", alignItems:'center', marginBottom:20 }} onPress={()=>showDatepicker()}>
...
<View style={{width:'70%', alignItems:'flex-start', margin:20}}>
              <Text style={{fontFamily:'Roboto', fontSize:25 }}>Type:</Text>
