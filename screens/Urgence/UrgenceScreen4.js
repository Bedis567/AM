  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={{alignItems:'center',paddingTop:adaptToHeight(0.1), justifyContent:'flex-end'}}>
          <Text style={{fontFamily:'Montserrat',fontSize:47, textAlign:'center',flex:0.27}}>
          Notification envoyée à vos proches  </Text>
          <Text style={{fontFamily:'Montserrat',fontSize:47,textAlign:'center',flex:0.3}}> 
          Prière de rester calme</Text>
          <Ionicons name={"warning-outline"} style={{ color: 'red',flex:.4 }} size={adaptToHeight(0.3)} /> 
        </View>
