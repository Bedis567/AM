  ...
  return (
    <SafeAreaView style={{flex:1, alignItems:'center', backgroundColor:colors.primary}}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>Jeux</Text></View>
...
<Text style={{fontFamily:'Montserrat', fontSize:20, textAlign:'center', paddingBottom:adaptToHeight(0.01)}}>
  Veuillez choisir la bonne réponse</Text>
...
<ModalPoupSucess visible={visible}>
        <View style={{alignItems: 'center'}}>
          <View style={styles.header}>
              <TouchableOpacity   onPress = {() => props.navigation.navigate('Jeu2')}>
                  <Image
