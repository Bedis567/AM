  ...
  return (
    ...
    <View style={{flex:0.4,
     ...
     <View style={{ width:adaptToWidth(0.9),flexDirection:'row', justifyContent:'space-around'}}>
         ...
         <TouchableOpacity style={{alignItems:'center'}}>
             <Text style={{fontFamily:'Montserrat-Bold', fontSize:17 , color:colors.purple}} onPress = {() => props.navigation.navigate('Login_proche')} >Se connecter</Text> 
         </TouchableOpacity>
         </View>
         </View>
         ...
         <View style={{ flex:0.6,justifyContent:'flex-start',alignItems:'center'}}>
          ...
          style={styles.button}>
              ...
              onPress = {() => props.navigation.navigate('Home_proche')}>Se Connecter</Text>
          </TouchableOpacity>
