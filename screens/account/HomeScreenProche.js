  ...
  return (
    <View style={styles.container}>
        ...
        <TouchableOpacity style={{alignItems:'center', margin:20, marginRight:40}} onPress = {() => props.navigation.navigate('Rappels1')}><Ionicons name={"alarm-outline"}
          ...
          <TouchableOpacity style={{alignItems:'center',margin:25, marginLeft:90, marginRight:40}}>
          ...
          <TouchableOpacity style={{alignItems:'center',marginVertical:25, marginLeft:15, marginRight:55}}>
          ...
          <View style={{flex:0.18, flexDirection:'row',justifyContent:'center'}}>
          <TouchableOpacity style={{alignItems:'center',marginTop:20,left:-5,marginRight:40}}>
            <Ionicons name={'person-circle-outline'} style={{color:colors.black}} size={60}/>
          ...
          <TouchableOpacity style={{alignItems:'center',marginTop:45,left:-35,marginRight:30}}>
            <Ionicons name={'warning-outline'} style={{color:colors.black}} size={60}/>
          <Text style={{marginVertical:10,
            fontFamily:'Montserrat',
            fontSize:18, width:150, textAlign:'center'}}>Déclarer un problème</Text></TouchableOpacity>
          <TouchableOpacity style={{alignItems:'center', width:100, height:150}} onPress = {() => props.navigation.navigate('Pilulier4')} ><Image style={{width:70,height:100,marginTop:20}} 
